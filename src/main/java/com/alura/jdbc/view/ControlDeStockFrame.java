    ...
    private void modificar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    Integer stock =(Integer) modelo.getValueAt(tabla.getSelectedRow(),3);


                    try {
                        this.productoController.modificar(nombre, descripcion, id, stock);
    ...
    private void eliminar() {
        ...
        Optional.ofNullable(modelo.getValueAt(tabla.getSelectedRow(), tabla.getSelectedColumn()))
                .ifPresentOrElse(fila -> {
                    ...
                    JOptionPane.showMessageDialog(this, "fueron removidos "+countDrop + "items con éxito!");
                }, () -> JOptionPane.showMessageDialog(this, "Por favor, elije un item"));
    }
